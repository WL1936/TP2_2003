...
anova(glmpoiscourant) # Le plus petit est hhkids avec 8.39, donc on a notre modèle courant

# Les variables conservées pour le b) se retrouve dans le tableau anova plus haut
...
# VaR0.99 dans un cas de 10 données doit êtr le max
